        ...
        <section className="about" id="about">
            <div className="content">
                <div className="img__container" ref={imgRef}>
                    <img className="img" src="./img/Adrien_Blanco.webp" alt="portrait Adrien Blanco"></img>
                </div>
                <p className="paragraph" ref={paraRef}>
                    ...
                    <br />
                    <br />
                    Après un parcours dans <span>la communication et la relation client</span>, c'est en 2022 que je saute le pas pour apprendre le <span>développement web front-end</span>.
                    <br />
                    Je rentre chez <span>OpenClassRooms</span> en tant qu'élève Intégrateur Web en <span>février 2023</span>.
                    Durant ma formation, j'ai touché à différents aspects du métier et j'ai pu me spécialiser en <span>React</span>.
                    <br />
                    <br />
